...
For example: the number of possible ways to deal a card game, winning lottery numbers
...
Not the same as the set that contains *everything*. Only the relevant things for what we're currently talking about (e.g., a country's population is the universal set for any survey sample)
...
This is also an example of a formulation of **Bayes' Theorem**, which more generally is stated as:
