...
It is the basis for Bayesian inference and Bayesian statistics
...
Instead of just numbers (as in previous examples), Bayesian statistics work with distributions
...
- We can calculate the probability that our data were created by different assumed parameter values
...
- Probability is our belief about how likely an event is, given our most reasonable information
